...
const Hero = () => {
  ...
  const handleProfileDownload = () => {
    ...
    link.href = '"C:\Users\User\Downloads\Distinguished Innovations Trading Company  (3).pdf"'; // You'll need to upload the PDF here
    link.download = '"C:\Users\User\Downloads\Distinguished Innovations Trading Company  (3).pdf"';
